...
namespace MyPetClinic.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260807041501_AddVoucherModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.BlockTime", b =>
                {
                    ...
                    b.ToTable("block_times", (string)null);
                });
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.DoctorScheduleProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("doctor_schedule_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.Offer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.OfferService", b =>
                {
                    ...
                    b.ToTable("offer_services", (string)null);
                });

            modelBuilder.Entity("MyPetClinic.Domain.Entities.OfferUsageLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("offer_usage_logs", (string)null);
                });
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.ScheduleException", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<Guid?>("SubstituteDoctorId")
                        .HasColumnType("uuid")
                        .HasColumnName("substitute_doctor_id");
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.ScheduleProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("schedule_profiles", (string)null);
                });

            modelBuilder.Entity("MyPetClinic.Domain.Entities.ScheduleProfileShift", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("schedule_profile_shifts", (string)null);
                });
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.UserOffer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("user_offers", (string)null);
                });
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.DoctorScheduleProfile", b =>
                {
                    ...
                    b.HasOne("MyPetClinic.Domain.Entities.ScheduleProfile", "Profile")
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.OfferService", b =>
                {
                    b.HasOne("MyPetClinic.Domain.Entities.Offer", "Offer")
            ...
            modelBuilder.Entity("MyPetClinic.Domain.Entities.ScheduleException", b =>
                {
                    ...
                    b.HasOne("MyPetClinic.Domain.Entities.User", "SubstituteDoctor")
                        .WithMany()
