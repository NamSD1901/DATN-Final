        ...
        public async Task<IActionResult> GetPetMedicalHistory(long petId, [FromQuery] int page = 1, [FromQuery] int pageSize = 10)
        {
            try
            {
                ...
                var customerRecords = historyPaginated.Items.Select(r => new MedicalRecordCustomerViewDto
                {
                    ...
                    MedicalHistory = _medicalRecordService.ExtractReadableSoap(r.MedicalHistory, "S"),
                    ClinicalSigns = _medicalRecordService.ExtractReadableSoap(r.ClinicalSigns, "O"),
                    TreatmentPlan = _medicalRecordService.ExtractReadableSoap(r.TreatmentPlan, "P"),
