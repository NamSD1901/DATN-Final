        ...
        public async Task<IActionResult> GetPetMedicalRecords(long id)
        {
            try
            {
                ...
                var customerRecords = records.Select(r => new MedicalRecordCustomerViewDto
                {
                    ...
                    Diagnosis = r.RawDiagnosis ?? r.Diagnosis,
                    MedicalHistory = r.RawMedicalHistory ?? r.MedicalHistory,
                    ClinicalSigns = r.RawClinicalSigns ?? r.ClinicalSigns,
                    TreatmentPlan = r.RawTreatmentPlan ?? r.TreatmentPlan,
