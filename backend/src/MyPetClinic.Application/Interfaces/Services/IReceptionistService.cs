...
namespace MyPetClinic.Application.Interfaces.Services
{
    public interface IReceptionistService
    {
        ...
        Task<QrGroupPreviewDto> GetAppointmentPreviewByQrAsync(string qrToken);
        ...
        Task<PaginatedResultDto<UserProfileDto>> GetCustomersPaginatedAsync(string? search, int pageIndex, int pageSize);
