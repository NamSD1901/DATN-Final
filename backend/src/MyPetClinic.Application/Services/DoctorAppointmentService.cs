...
namespace MyPetClinic.Application.Services
{
    public class DoctorAppointmentService : IDoctorAppointmentService
    {
        ...
        public DoctorAppointmentService(IUnitOfWork unitOfWork, IVaccinationScheduleChecker vaccinationScheduleChecker, INotificationService notificationService, IEmailQueue emailQueue)
        {
